...
echo 'export SECRET_GEMINI_API_KEY=$(echo -n "your-gemini-api-key-here" | base64)' >> ~/.zshrc # required
echo 'export SECRET_OPENAI_API_KEY=$(echo -n "your-open-api-key-here" | base64)' >> ~/.zshrc    # required for flow 3
echo 'export SECRET_TAVILY_API_KEY=$(echo -n "your-tavily-api-key-here" | base64)' >> ~/.zshrc    # optional
```
